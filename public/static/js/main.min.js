...
$(document).on('click','.about',function(){
    layer.open({
        ...
        resize:false,
        scrollbar:false,
        content:'<div style="text-align:center;margin-top:30px"><img src="static/images/about.png" width="auto" height="180px"><div style="margin-top:25px;color:#555">© 2019 <a href="https://github.com/xb2016/New-Mso-User" target="_blank" rel="nofollow" style="color:#ff8e3a">Moedog</a> . All Rights Received.</div></div>'
    });
});
